...
\begin{table}[]
    ...
    \multirow{2}{*}{$(-\infty, d]$} & \multirow{2}{*}{$(-\infty, d]$} & \multicolumn{1}{l|}{$d \le b$}                  & $(-\infty, b]$                  & \multicolumn{1}{l|}{$d \le b$}               & $(-\infty, b]$ & \multicolumn{2}{l|}{\multirow{2}{*}{$\top$}}                                      & \multirow{2}{*}{$\top$} \\ \cline{3-6}
                                    &                                 & \multicolumn{1}{l|}{otherwise}                  & $\top$                          & \multicolumn{1}{l|}{otherwise}               & $\top$         & \multicolumn{2}{l|}{}                                                             &                         \\ \hline
    \multirow{4}{*}{$[c, d]$}       & \multirow{4}{*}{$[c, d]$}       & \multicolumn{1}{l|}{\multirow{2}{*}{$d \le b$}} & \multirow{2}{*}{$(-\infty, b]$} & \multicolumn{1}{l|}{$a \le c \land d \le b$} & $[a, b]$       & \multicolumn{1}{l|}{\multirow{2}{*}{$a \le c$}} & \multirow{2}{*}{$[a, +\infty)$} & \multirow{2}{*}{$\top$} \\ \cline{5-6}
                                    &                                 & \multicolumn{1}{l|}{}                           &                                 & \multicolumn{1}{l|}{$a \le c \land d > b$}   & $[a, +\infty)$ & \multicolumn{1}{l|}{}                           &                                 &                         \\ \cline{3-9} 
                                    &                                 & \multicolumn{1}{l|}{\multirow{2}{*}{otherwise}} & \multirow{2}{*}{$\top$}         & \multicolumn{1}{l|}{$a > c \land d \le b$}   & $(-\infty, b]$ & \multicolumn{1}{l|}{\multirow{2}{*}{otherwise}} & \multirow{2}{*}{$\top$}         & \multirow{2}{*}{$\top$} \\ \cline{5-6}
